...
carray-fdt_serial_drivers-$(CONFIG_FDT_SERIAL_NUCLEI) += fdt_serial_nuclei
libsbiutils-objs-$(CONFIG_FDT_SERIAL_NUCLEI) += serial/fdt_serial_nuclei.o
...
libsbiutils-objs-$(CONFIG_SERIAL_NUCLEI) += serial/nuclei-uart.o
