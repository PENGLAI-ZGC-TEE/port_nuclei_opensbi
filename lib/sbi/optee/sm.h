...
#define OPTEE_SECURE_DEVICE_BASE		FW_OPTEE_SECURE_DEVICE_BASE
#else
#define OPTEE_SECURE_DEVICE_BASE		0x10012000
#endif

#ifdef FW_OPTEE_SECURE_DEVICE_SIZE
#define OPTEE_SECURE_DEVICE_SIZE		FW_OPTEE_SECURE_DEVICE_SIZE
#else
#define OPTEE_SECURE_DEVICE_SIZE		0x1000
#endif
